...
class MailchimpClient(
    ...
    fun postInterestsCategories(
        listId: String,
        interestCategory: MailchimpInterestCategory,
    ...
    private fun convertObjectNodeToMailchimpInterestCategory(it: JsonNode): MailchimpInterestCategory =
        MailchimpInterestCategory(
            id = it.get("id").asText(),
    ...
    private fun convertObjectNodeToMailchimpInterest(it: JsonNode): MailchimpInterest =
        MailchimpInterest(
            id = it.get("id").asText(),
            name = it.get("name").asText(),
        )

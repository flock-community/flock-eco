...
export function WorkspaceForm({value, onSubmit}: Props) {
  ...
  const renderVariables = (props: FormikProps<WorkspaceInput>) => (helpers: ArrayHelpers) => {
    const addVariable = () => helpers.insert(props.values.variables.length, {key: '', value: ''})
  ...
  const renderForm = (props: FormikProps<WorkspaceInput>) => (<Form id={WORKSPACE_FORM_ID}>

...
class WorkspaceService(
    ...
    fun findAll(pageable: Pageable): Page<Workspace> =
        workspaceRepository
            .findAll(pageable)
    ...
    fun findWorkspacesByUserId(userId: String): Set<Workspace> = workspaceRepository.findAllByUsersUserId(userId)

    fun create(input: Workspace): Workspace =
        input
            .save()
    ...
    fun addWorkspaceUser(
        ...
        ?.let {
            val user =
                workspaceUserProvider.findWorkspaceUsers(ref)
